...
const copy = {
  en: {
    ...
    problem: 'What work is too sensitive or important for public AI?',
    problemPlaceholder: 'Tell us what happens today, which data is involved and what should improve.',
    button: 'Explore a private deployment',
    sending: 'Sending…',
    successTitle: 'Thank you. We’ll review the work and reply.',
    successText: 'We’ll suggest the first private AI system to explore, where it could run and the result worth testing.',
  ...
  sv: {
    ...
    problem: 'Vilket arbete är för känsligt eller viktigt för publik AI?',
    problemPlaceholder: 'Berätta hur det fungerar idag, vilken data som används och vad som ska bli bättre.',
    button: 'Utforska en privat driftsättning',
    sending: 'Skickar…',
    successTitle: 'Tack. Vi går igenom arbetet och återkommer.',
    successText: 'Vi föreslår det första privata AI-systemet att utforska, var det kan köras och vilket resultat som är värt att testa.',
